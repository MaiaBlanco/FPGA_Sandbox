...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "convolve_kernel.autotvin.dat"
	set constFileTvOut       "convolve_kernel.autotvout.dat"
	set constFileHdlTvIn     "convolve_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "convolve_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
