...
if {[file isfile convolve_kernel.autotvin.dat]} {
	file delete -force convolve_kernel.autotvin.dat
}

if {[file isfile convolve_kernel.autotvout.dat]} {
	file delete -force convolve_kernel.autotvout.dat
}
