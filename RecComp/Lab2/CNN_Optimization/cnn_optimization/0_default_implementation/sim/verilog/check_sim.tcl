...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.convolve_kernel.autotvin_bufw.dat"
         "c.convolve_kernel.autotvin_bufi.dat"
         "c.convolve_kernel.autotvin_bufo.dat"
         "c.convolve_kernel.autotvout_bufo.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.convolve_kernel.autotvout_bufo.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
