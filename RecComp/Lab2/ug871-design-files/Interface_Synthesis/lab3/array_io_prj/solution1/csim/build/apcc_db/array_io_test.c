...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = call i8* @memcpy(i8* %%1, i8* bitcast ([32 x i16]* @aesl_internal_main.d_i to i8*), i32 64 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_3_count);
  ( char *)memcpy(( char *)llvm_cbe_tmp__1, ( char *)(( char *)(&aesl_internal_main_OC_d_i)), 64u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",64u);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__2);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds [32 x i16]* %%d_o, i32 0, i32 0, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_8_count);
  llvm_cbe_tmp__3 = (signed short *)(&llvm_cbe_d_o[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 32
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = getelementptr inbounds [32 x i16]* %%d_i, i32 0, i32 0, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_9_count);
  llvm_cbe_tmp__4 = (signed short *)(&llvm_cbe_d_i[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 32
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = call %%struct._iobuf* @fopen(i8* getelementptr inbounds ([11 x i8]* @aesl_internal_.str, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str1, i32 0, i32 0)) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_11_count);
  llvm_cbe_tmp__5 = (l_struct_OC__iobuf *)aesl_fopen(( char *)((&aesl_internal__OC_str[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 11
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = call i32 @fwrite(i8* getelementptr inbounds ([10 x i8]* @aesl_internal_.str2, i32 0, i32 0), i32 9, i32 1, %%struct._iobuf* %%5), !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_16_count);
  fwrite(( char *)((&aesl_internal__OC_str2[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 10
#endif
])), 9u, 1u, (l_struct_OC__iobuf *)llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",9u);
printf("\nArgument  = 0x%X",1u);
...
llvm_cbe_tmp__18:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2 = phi i32 [ 0, %%0 ], [ %%15, %%7  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge2_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = getelementptr inbounds [32 x i16]* %%d_i, i32 0, i32 %%storemerge2, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_23_count);
  llvm_cbe_tmp__7 = (signed short *)(&llvm_cbe_d_i[(((signed int )llvm_cbe_storemerge2))
#ifdef AESL_BC_SIM
 % 32
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed int )llvm_cbe_storemerge2) < 32)) fprintf(stderr, "%s:%d: warning: Read access out of array 'd_i' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = load i16* %%8, align 2, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_24_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds [32 x i16]* %%d_o, i32 0, i32 %%storemerge2, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_26_count);
  llvm_cbe_tmp__10 = (signed short *)(&llvm_cbe_d_o[(((signed int )llvm_cbe_storemerge2))
#ifdef AESL_BC_SIM
 % 32
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed int )llvm_cbe_storemerge2) < 32)) fprintf(stderr, "%s:%d: warning: Read access out of array 'd_o' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = load i16* %%11, align 2, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_27_count);
  llvm_cbe_tmp__11 = (unsigned short )*llvm_cbe_tmp__10;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = sext i16 %%12 to i32, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_28_count);
  llvm_cbe_tmp__12 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%5, i8* getelementptr inbounds ([9 x i8]* @aesl_internal_.str3, i32 0, i32 0), i32 %%10, i32 %%13) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_29_count);
  fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__5, ( char *)((&aesl_internal__OC_str3[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 9
#endif
])), llvm_cbe_tmp__9, llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = add nsw i32 %%storemerge2, 1, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_30_count);
  llvm_cbe_tmp__14 = (unsigned int )((unsigned int )(llvm_cbe_storemerge2&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__14&4294967295ull)));
  if (((llvm_cbe_tmp__14&4294967295U) == (32u&4294967295U))) {
    goto llvm_cbe_tmp__19;
  } else {
    llvm_cbe_storemerge2__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__14;   /* for PHI node */
    goto llvm_cbe_tmp__18;
  }
...
llvm_cbe_tmp__19:
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = call i32 @fclose(%%struct._iobuf* %%5) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_37_count);
  fclose((l_struct_OC__iobuf *)llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__15);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = call i32 bitcast (i32 (...)* @system to i32 (i8*)*)(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str4, i32 0, i32 0)) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_38_count);
  llvm_cbe_tmp__16 = (unsigned int )system(( char *)((&aesl_internal__OC_str4[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 45
#endif
])));
...
llvm_cbe_tmp__21:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts = call i32 @puts(i8* getelementptr inbounds ([17 x i8]* @aesl_internal_str, i32 0, i32 0)), !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_puts_count);
...
llvm_cbe_tmp__20:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts1 = call i32 @puts(i8* getelementptr inbounds ([14 x i8]* @aesl_internal_str1, i32 0, i32 0)), !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_puts1_count);
...
llvm_cbe_tmp__22:
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = phi i32 [ 0, %%21 ], [ 1, %%20  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_49_count);
