; ModuleID = 'C:/Users/markb/Source/Repos/FPGA_Sandbox/RecComp/Lab2/Zynq_Book/hls/tut3A/matrix_mult_prj/solution2/.autopilot/db/a.o.bc'
...
; <label>:26                                      ; preds = %23
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !61 ; [debug line = 16:1]
  ...
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !63 ; [debug line = 17:10]
...
!61 = metadata !{i32 16, i32 1, metadata !60, null}
!62 = metadata !{i32 16, i32 13, metadata !60, null}
!63 = metadata !{i32 17, i32 10, metadata !60, null}
!64 = metadata !{i32 15, i32 41, metadata !56, null}
