; ModuleID = 'C:/Users/markb/Source/Repos/FPGA_Sandbox/RecComp/Lab2/Zynq_Book/hls/tut3A/matrix_mult_prj/solution2/.autopilot/db/a.g.1.bc'
...
; <label>:6                                       ; preds = %5
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !54 ; [debug line = 16:1]
  ...
  %rend4 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0), i32 %rbegin3) nounwind, !dbg !56 ; [#uses=0 type=i32] [debug line = 17:10]
...
!54 = metadata !{i32 16, i32 1, metadata !53, null}
!55 = metadata !{i32 16, i32 13, metadata !53, null}
!56 = metadata !{i32 17, i32 10, metadata !53, null}
!57 = metadata !{i32 15, i32 41, metadata !51, null}
!58 = metadata !{i32 786688, metadata !51, metadata !"k", metadata !6, i32 15, metadata !59, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
