...
#ifndef __matrix_mult_mul_8bkb__HH__
#define __matrix_mult_mul_8bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matrix_mult_mul_8bkb) {
    ...
    SC_CTOR(matrix_mult_mul_8bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
