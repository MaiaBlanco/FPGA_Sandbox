; ModuleID = 'C:/Users/markb/Source/Repos/FPGA_Sandbox/RecComp/Lab2/Zynq_Book/hls/tut3A/matrix_mult_prj/solution3/.autopilot/db/a.g.1.bc'
...
; <label>:4                                       ; preds = %3
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !49 ; [debug line = 13:1]
  %prod.addr = getelementptr inbounds [5 x i16]* %prod, i32 %i, i32 %j, !dbg !50 ; [#uses=3 type=i16*] [debug line = 13:10]
  store i16 0, i16* %prod.addr, align 2, !dbg !50 ; [debug line = 13:10]
  br label %5, !dbg !51                           ; [debug line = 15:32]

; <label>:5                                       ; preds = %6, %4
  %k = phi i32 [ 0, %4 ], [ %k.1, %6 ]            ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %k, 5, !dbg !51         ; [#uses=1 type=i1] [debug line = 15:32]
  br i1 %exitcond, label %7, label %6, !dbg !51   ; [debug line = 15:32]

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !53 ; [debug line = 15:47]
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !53 ; [#uses=1 type=i32] [debug line = 15:47]
  %a.addr = getelementptr inbounds [5 x i8]* %a, i32 %i, i32 %k, !dbg !55 ; [#uses=1 type=i8*] [debug line = 16:13]
  %a.load = load i8* %a.addr, align 1, !dbg !55   ; [#uses=2 type=i8] [debug line = 16:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %a.load) nounwind
  %tmp = sext i8 %a.load to i16, !dbg !55         ; [#uses=1 type=i16] [debug line = 16:13]
  %b.addr = getelementptr inbounds [5 x i8]* %b, i32 %k, i32 %j, !dbg !55 ; [#uses=1 type=i8*] [debug line = 16:13]
  %b.load = load i8* %b.addr, align 1, !dbg !55   ; [#uses=2 type=i8] [debug line = 16:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %b.load) nounwind
  %tmp.1 = sext i8 %b.load to i16, !dbg !55       ; [#uses=1 type=i16] [debug line = 16:13]
  %tmp.2 = mul i16 %tmp.1, %tmp, !dbg !55         ; [#uses=1 type=i16] [debug line = 16:13]
  %prod.load = load i16* %prod.addr, align 2, !dbg !55 ; [#uses=2 type=i16] [debug line = 16:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %prod.load) nounwind
  %tmp.3 = add i16 %prod.load, %tmp.2, !dbg !55   ; [#uses=1 type=i16] [debug line = 16:13]
  store i16 %tmp.3, i16* %prod.addr, align 2, !dbg !55 ; [debug line = 16:13]
  %rend4 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str3, i32 0, i32 0), i32 %rbegin3) nounwind, !dbg !56 ; [#uses=0 type=i32] [debug line = 17:10]
  %k.1 = add nsw i32 %k, 1, !dbg !57              ; [#uses=1 type=i32] [debug line = 15:41]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !58), !dbg !57 ; [debug line = 15:41] [debug variable = k]
  br label %5, !dbg !57                           ; [debug line = 15:41]

; <label>:7                                       ; preds = %5
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !60 ; [#uses=0 type=i32] [debug line = 18:7]
  %j.1 = add nsw i32 %j, 1, !dbg !61              ; [#uses=1 type=i32] [debug line = 12:34]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !62), !dbg !61 ; [debug line = 12:34] [debug variable = j]
  br label %3, !dbg !61                           ; [debug line = 12:34]

; <label>:8                                       ; preds = %3
  %rend6 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %rbegin5) nounwind, !dbg !63 ; [#uses=0 type=i32] [debug line = 19:4]
  %i.1 = add nsw i32 %i, 1, !dbg !64              ; [#uses=1 type=i32] [debug line = 10:31]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !65), !dbg !64 ; [debug line = 10:31] [debug variable = i]
  br label %1, !dbg !64                           ; [debug line = 10:31]

; <label>:9                                       ; preds = %1
  ret void, !dbg !66                              ; [debug line = 21:1]
}
...
!49 = metadata !{i32 13, i32 1, metadata !48, null}
!50 = metadata !{i32 13, i32 10, metadata !48, null}
!51 = metadata !{i32 15, i32 32, metadata !52, null}
!52 = metadata !{i32 786443, metadata !48, i32 15, i32 19, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!53 = metadata !{i32 15, i32 47, metadata !54, null}
!54 = metadata !{i32 786443, metadata !52, i32 15, i32 46, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!55 = metadata !{i32 16, i32 13, metadata !54, null}
!56 = metadata !{i32 17, i32 10, metadata !54, null}
!57 = metadata !{i32 15, i32 41, metadata !52, null}
!58 = metadata !{i32 786688, metadata !52, metadata !"k", metadata !6, i32 15, metadata !59, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!59 = metadata !{i32 786468, null, metadata !"int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!60 = metadata !{i32 18, i32 7, metadata !48, null}
!61 = metadata !{i32 12, i32 34, metadata !46, null}
!62 = metadata !{i32 786688, metadata !46, metadata !"j", metadata !6, i32 12, metadata !59, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!63 = metadata !{i32 19, i32 4, metadata !44, null}
!64 = metadata !{i32 10, i32 31, metadata !42, null}
!65 = metadata !{i32 786688, metadata !42, metadata !"i", metadata !6, i32 10, metadata !59, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!66 = metadata !{i32 21, i32 1, metadata !38, null}
