; ModuleID = 'C:/Users/markb/Source/Repos/FPGA_Sandbox/RecComp/Lab2/Zynq_Book/hls/tut3A/matrix_mult_prj/solution1/.autopilot/db/a.o.bc'
...
; <label>:16                                      ; preds = %13
  ...
  %17 = load i32* %j, align 4, !dbg !54           ; [#uses=1 type=i32] [debug line = 13:10]
  %18 = load i32* %i, align 4, !dbg !54           ; [#uses=1 type=i32] [debug line = 13:10]
  %19 = load [5 x i16]** %3, align 4, !dbg !54    ; [#uses=1 type=[5 x i16]*] [debug line = 13:10]
  %20 = getelementptr inbounds [5 x i16]* %19, i32 %18, !dbg !54 ; [#uses=1 type=[5 x i16]*] [debug line = 13:10]
  %21 = getelementptr inbounds [5 x i16]* %20, i32 0, i32 %17, !dbg !54 ; [#uses=1 type=i16*] [debug line = 13:10]
  store i16 0, i16* %21, align 2, !dbg !54        ; [debug line = 13:10]
  br label %22, !dbg !54                          ; [debug line = 13:10]

; <label>:22                                      ; preds = %16
  call void @llvm.dbg.declare(metadata !{i32* %k}, metadata !55), !dbg !57 ; [debug line = 15:27] [debug variable = k]
  store i32 0, i32* %k, align 4, !dbg !58         ; [debug line = 15:32]
  br label %23, !dbg !58                          ; [debug line = 15:32]

; <label>:23                                      ; preds = %51, %22
  %24 = load i32* %k, align 4, !dbg !58           ; [#uses=1 type=i32] [debug line = 15:32]
  %25 = icmp slt i32 %24, 5, !dbg !58             ; [#uses=1 type=i1] [debug line = 15:32]
  br i1 %25, label %26, label %54, !dbg !58       ; [debug line = 15:32]

; <label>:26                                      ; preds = %23
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !59 ; [debug line = 15:47]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !59 ; [debug line = 15:47]
  %27 = load i32* %k, align 4, !dbg !61           ; [#uses=1 type=i32] [debug line = 16:13]
  %28 = load i32* %i, align 4, !dbg !61           ; [#uses=1 type=i32] [debug line = 16:13]
  %29 = load [5 x i8]** %1, align 4, !dbg !61     ; [#uses=1 type=[5 x i8]*] [debug line = 16:13]
  %30 = getelementptr inbounds [5 x i8]* %29, i32 %28, !dbg !61 ; [#uses=1 type=[5 x i8]*] [debug line = 16:13]
  %31 = getelementptr inbounds [5 x i8]* %30, i32 0, i32 %27, !dbg !61 ; [#uses=1 type=i8*] [debug line = 16:13]
  %32 = load i8* %31, align 1, !dbg !61           ; [#uses=1 type=i8] [debug line = 16:13]
  %33 = sext i8 %32 to i32, !dbg !61              ; [#uses=1 type=i32] [debug line = 16:13]
  %34 = load i32* %j, align 4, !dbg !61           ; [#uses=1 type=i32] [debug line = 16:13]
  %35 = load i32* %k, align 4, !dbg !61           ; [#uses=1 type=i32] [debug line = 16:13]
  %36 = load [5 x i8]** %2, align 4, !dbg !61     ; [#uses=1 type=[5 x i8]*] [debug line = 16:13]
  %37 = getelementptr inbounds [5 x i8]* %36, i32 %35, !dbg !61 ; [#uses=1 type=[5 x i8]*] [debug line = 16:13]
  %38 = getelementptr inbounds [5 x i8]* %37, i32 0, i32 %34, !dbg !61 ; [#uses=1 type=i8*] [debug line = 16:13]
  %39 = load i8* %38, align 1, !dbg !61           ; [#uses=1 type=i8] [debug line = 16:13]
  %40 = sext i8 %39 to i32, !dbg !61              ; [#uses=1 type=i32] [debug line = 16:13]
  %41 = mul nsw i32 %33, %40, !dbg !61            ; [#uses=1 type=i32] [debug line = 16:13]
  %42 = load i32* %j, align 4, !dbg !61           ; [#uses=1 type=i32] [debug line = 16:13]
  %43 = load i32* %i, align 4, !dbg !61           ; [#uses=1 type=i32] [debug line = 16:13]
  %44 = load [5 x i16]** %3, align 4, !dbg !61    ; [#uses=1 type=[5 x i16]*] [debug line = 16:13]
  %45 = getelementptr inbounds [5 x i16]* %44, i32 %43, !dbg !61 ; [#uses=1 type=[5 x i16]*] [debug line = 16:13]
  %46 = getelementptr inbounds [5 x i16]* %45, i32 0, i32 %42, !dbg !61 ; [#uses=2 type=i16*] [debug line = 16:13]
  %47 = load i16* %46, align 2, !dbg !61          ; [#uses=1 type=i16] [debug line = 16:13]
  %48 = sext i16 %47 to i32, !dbg !61             ; [#uses=1 type=i32] [debug line = 16:13]
  %49 = add nsw i32 %48, %41, !dbg !61            ; [#uses=1 type=i32] [debug line = 16:13]
  %50 = trunc i32 %49 to i16, !dbg !61            ; [#uses=1 type=i16] [debug line = 16:13]
  store i16 %50, i16* %46, align 2, !dbg !61      ; [debug line = 16:13]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !62 ; [debug line = 17:10]
  br label %51, !dbg !62                          ; [debug line = 17:10]

; <label>:51                                      ; preds = %26
  %52 = load i32* %k, align 4, !dbg !63           ; [#uses=1 type=i32] [debug line = 15:41]
  %53 = add nsw i32 %52, 1, !dbg !63              ; [#uses=1 type=i32] [debug line = 15:41]
  store i32 %53, i32* %k, align 4, !dbg !63       ; [debug line = 15:41]
  br label %23, !dbg !63                          ; [debug line = 15:41]

; <label>:54                                      ; preds = %23
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !64 ; [debug line = 18:7]
  br label %55, !dbg !64                          ; [debug line = 18:7]

; <label>:55                                      ; preds = %54
  %56 = load i32* %j, align 4, !dbg !65           ; [#uses=1 type=i32] [debug line = 12:34]
  %57 = add nsw i32 %56, 1, !dbg !65              ; [#uses=1 type=i32] [debug line = 12:34]
  store i32 %57, i32* %j, align 4, !dbg !65       ; [debug line = 12:34]
  br label %13, !dbg !65                          ; [debug line = 12:34]

; <label>:58                                      ; preds = %13
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !66 ; [debug line = 19:4]
  br label %59, !dbg !66                          ; [debug line = 19:4]

; <label>:59                                      ; preds = %58
  %60 = load i32* %i, align 4, !dbg !67           ; [#uses=1 type=i32] [debug line = 10:31]
  %61 = add nsw i32 %60, 1, !dbg !67              ; [#uses=1 type=i32] [debug line = 10:31]
  store i32 %61, i32* %i, align 4, !dbg !67       ; [debug line = 10:31]
  br label %8, !dbg !67                           ; [debug line = 10:31]

; <label>:62                                      ; preds = %8
  ret void, !dbg !68                              ; [debug line = 21:1]
}
...
!54 = metadata !{i32 13, i32 10, metadata !53, null}
!55 = metadata !{i32 786688, metadata !56, metadata !"k", metadata !6, i32 15, metadata !43, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!56 = metadata !{i32 786443, metadata !53, i32 15, i32 19, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!57 = metadata !{i32 15, i32 27, metadata !56, null}
!58 = metadata !{i32 15, i32 32, metadata !56, null}
!59 = metadata !{i32 15, i32 47, metadata !60, null}
!60 = metadata !{i32 786443, metadata !56, i32 15, i32 46, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!61 = metadata !{i32 16, i32 13, metadata !60, null}
!62 = metadata !{i32 17, i32 10, metadata !60, null}
!63 = metadata !{i32 15, i32 41, metadata !56, null}
!64 = metadata !{i32 18, i32 7, metadata !53, null}
!65 = metadata !{i32 12, i32 34, metadata !49, null}
!66 = metadata !{i32 19, i32 4, metadata !47, null}
!67 = metadata !{i32 10, i32 31, metadata !42, null}
!68 = metadata !{i32 21, i32 1, metadata !38, null}
