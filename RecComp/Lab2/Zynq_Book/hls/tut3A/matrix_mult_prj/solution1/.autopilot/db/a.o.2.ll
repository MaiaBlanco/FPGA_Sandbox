...
; <label>:1                                       ; preds = %12, %0
  %i = phi i3 [ 0, %0 ], [ %i.1, %12 ]            ; [#uses=3 type=i3]
  ...
  br i1 %exitcond2, label %14, label %3, !dbg !55 ; [debug line = 10:22]
...
; <label>:4                                       ; preds = %10, %3
  %j = phi i3 [ 0, %3 ], [ %j.1, %10 ]            ; [#uses=3 type=i3]
  ...
  br i1 %exitcond1, label %12, label %6, !dbg !60 ; [debug line = 12:25]
...
; <label>:7                                       ; preds = %9, %6
  ...
  br i1 %exitcond, label %10, label %9, !dbg !65  ; [debug line = 15:32]

; <label>:9                                       ; preds = %7
  call void (...)* @_ssdm_op_SpecLoopName([8 x i8]* @.str2) nounwind, !dbg !67 ; [debug line = 15:47]
  %a.addr = getelementptr [5 x [5 x i8]]* %a, i32 0, i32 %i.cast3, i32 %k.cast1, !dbg !69 ; [#uses=1 type=i8*] [debug line = 16:13]
  %a.load = load i8* %a.addr, align 1, !dbg !69   ; [#uses=1 type=i8] [debug line = 16:13]
  %tmp = sext i8 %a.load to i16, !dbg !69         ; [#uses=1 type=i16] [debug line = 16:13]
  %b.addr = getelementptr [5 x [5 x i8]]* %b, i32 0, i32 %k.cast1, i32 %j.cast2, !dbg !69 ; [#uses=1 type=i8*] [debug line = 16:13]
  %b.load = load i8* %b.addr, align 1, !dbg !69   ; [#uses=1 type=i8] [debug line = 16:13]
  %tmp.1 = sext i8 %b.load to i16, !dbg !69       ; [#uses=1 type=i16] [debug line = 16:13]
  %tmp.2 = mul i16 %tmp, %tmp.1, !dbg !69         ; [#uses=1 type=i16] [debug line = 16:13]
  %prod.load = load i16* %prod.addr, align 2, !dbg !69 ; [#uses=1 type=i16] [debug line = 16:13]
  %tmp.3 = add i16 %tmp.2, %prod.load, !dbg !69   ; [#uses=1 type=i16] [debug line = 16:13]
  store i16 %tmp.3, i16* %prod.addr, align 2, !dbg !69 ; [debug line = 16:13]
  %k.1 = add i3 %k, 1, !dbg !70                   ; [#uses=1 type=i3] [debug line = 15:41]
  call void @llvm.dbg.value(metadata !{i3 %k.1}, i64 0, metadata !71), !dbg !70 ; [debug line = 15:41] [debug variable = k]
  br label %7, !dbg !70                           ; [debug line = 15:41]

; <label>:10                                      ; preds = %7
  %11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str1, i32 %tmp.5) nounwind, !dbg !73 ; [#uses=0 type=i32] [debug line = 18:7]
  %j.1 = add i3 %j, 1, !dbg !74                   ; [#uses=1 type=i3] [debug line = 12:34]
  call void @llvm.dbg.value(metadata !{i3 %j.1}, i64 0, metadata !75), !dbg !74 ; [debug line = 12:34] [debug variable = j]
  br label %4, !dbg !74                           ; [debug line = 12:34]

; <label>:12                                      ; preds = %4
  %13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str, i32 %tmp.4) nounwind, !dbg !76 ; [#uses=0 type=i32] [debug line = 19:4]
  %i.1 = add i3 %i, 1, !dbg !77                   ; [#uses=1 type=i3] [debug line = 10:31]
  call void @llvm.dbg.value(metadata !{i3 %i.1}, i64 0, metadata !78), !dbg !77 ; [debug line = 10:31] [debug variable = i]
  br label %1, !dbg !77                           ; [debug line = 10:31]
...
!69 = metadata !{i32 16, i32 13, metadata !68, null}
!70 = metadata !{i32 15, i32 41, metadata !66, null}
!71 = metadata !{i32 786688, metadata !66, metadata !"k", metadata !6, i32 15, metadata !72, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!74 = metadata !{i32 12, i32 34, metadata !61, null}
!75 = metadata !{i32 786688, metadata !61, metadata !"j", metadata !6, i32 12, metadata !72, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!76 = metadata !{i32 19, i32 4, metadata !59, null}
!77 = metadata !{i32 10, i32 31, metadata !56, null}
!78 = metadata !{i32 786688, metadata !56, metadata !"i", metadata !6, i32 10, metadata !72, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!79 = metadata !{i32 21, i32 1, metadata !57, null}
