...
proc create_root_design { parentCell } {
  ...
  # Create instance: convolve_kernel_1, and set properties
  set convolve_kernel_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:convolve_kernel:1.0 convolve_kernel_1 ]
...
CONFIG.NUM_MI {4} \
  ...
  connect_bd_intf_net -intf_net convolve_kernel_0_bufi_PORTA [get_bd_intf_pins convolve_kernel_1/bufi_PORTA] [get_bd_intf_pins hier_bram_0/BRAM_PORTB]
  connect_bd_intf_net -intf_net convolve_kernel_0_bufo_PORTA [get_bd_intf_pins convolve_kernel_1/bufo_PORTA] [get_bd_intf_pins hier_bram_2/BRAM_PORTB]
  connect_bd_intf_net -intf_net convolve_kernel_0_bufw_PORTA [get_bd_intf_pins convolve_kernel_1/bufw_PORTA] [get_bd_intf_pins hier_bram_1/BRAM_PORTB]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins convolve_kernel_1/s_axi_control] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins convolve_kernel_1/ap_rst_n] [get_bd_pins hier_bram_0/s_axi_lite_aresetn] [get_bd_pins hier_bram_1/s_axi_lite_aresetn] [get_bd_pins hier_bram_2/s_axi_lite_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs convolve_kernel_1/s_axi_control/Reg] SEG_convolve_kernel_1_Reg
