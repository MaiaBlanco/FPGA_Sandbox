...
proc create_hier_cell_hier_bram_2 { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_hier_bram_2() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_hier_bram_1 { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_hier_bram_1() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_hier_bram_0 { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_hier_bram_0() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  # Create instance: convolve_kernel_0, and set properties
  set convolve_kernel_0 [ create_bd_cell -type ip -vlnv RecComp:cnn_lab:convolve_kernel:0.5 convolve_kernel_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /convolve_kernel_0/s_axi_control]
  ...
  connect_bd_intf_net -intf_net convolve_kernel_0_bufi_PORTA [get_bd_intf_pins convolve_kernel_0/bufi_PORTA] [get_bd_intf_pins hier_bram_0/BRAM_PORTB]
  connect_bd_intf_net -intf_net convolve_kernel_0_bufo_PORTA [get_bd_intf_pins convolve_kernel_0/bufo_PORTA] [get_bd_intf_pins hier_bram_2/BRAM_PORTB]
  connect_bd_intf_net -intf_net convolve_kernel_0_bufw_PORTA [get_bd_intf_pins convolve_kernel_0/bufw_PORTA] [get_bd_intf_pins hier_bram_1/BRAM_PORTB]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins convolve_kernel_0/s_axi_control] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins convolve_kernel_0/ap_clk] [get_bd_pins hier_bram_0/s_axi_lite_aclk] [get_bd_pins hier_bram_1/s_axi_lite_aclk] [get_bd_pins hier_bram_2/s_axi_lite_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins convolve_kernel_0/ap_rst_n] [get_bd_pins hier_bram_0/ARESETN] [get_bd_pins hier_bram_1/ARESETN] [get_bd_pins hier_bram_2/ARESETN] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins hier_bram_0/s_axi_lite_aresetn] [get_bd_pins hier_bram_1/s_axi_lite_aresetn] [get_bd_pins hier_bram_2/s_axi_lite_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x7E200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hier_bram_0/axi_cdma_0/S_AXI_LITE/Reg] SEG_axi_cdma_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x7E210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hier_bram_1/axi_cdma_0/S_AXI_LITE/Reg] SEG_axi_cdma_0_Reg1
  create_bd_addr_seg -range 0x00010000 -offset 0x7E220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hier_bram_2/axi_cdma_0/S_AXI_LITE/Reg] SEG_axi_cdma_0_Reg2
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs convolve_kernel_0/s_axi_control/Reg] SEG_convolve_kernel_0_Reg
  create_bd_addr_seg -range 0x00002000 -offset 0xC0000000 [get_bd_addr_spaces hier_bram_0/axi_cdma_0/Data] [get_bd_addr_segs hier_bram_0/axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces hier_bram_0/axi_cdma_0/Data] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00002000 -offset 0xC2000000 [get_bd_addr_spaces hier_bram_1/axi_cdma_0/Data] [get_bd_addr_segs hier_bram_1/axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces hier_bram_1/axi_cdma_0/Data] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x00002000 -offset 0xC4000000 [get_bd_addr_spaces hier_bram_2/axi_cdma_0/Data] [get_bd_addr_segs hier_bram_2/axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces hier_bram_2/axi_cdma_0/Data] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
