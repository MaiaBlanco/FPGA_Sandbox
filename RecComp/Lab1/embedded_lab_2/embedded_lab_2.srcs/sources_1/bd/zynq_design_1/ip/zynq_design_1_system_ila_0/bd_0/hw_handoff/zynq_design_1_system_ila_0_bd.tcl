...
################################################################
# This is a generated script based on design: bd_350b
#
...
CONFIG.ASSOCIATED_BUSIF {SLOT_0_AXI:SLOT_2_AXI} \
...
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_ports SLOT_2_AXI] [get_bd_intf_pins g_inst/slot_1_axi]
  ...
  connect_bd_net -net SLOT_1_GPIO_tri_o_1 [get_bd_ports SLOT_1_GPIO_tri_o] [get_bd_pins ila_lib/probe16]
  ...
  connect_bd_net -net net_slot_2_axi_ar_cnt [get_bd_pins g_inst/m_slot_1_axi_ar_cnt] [get_bd_pins ila_lib/probe17]
  connect_bd_net -net net_slot_2_axi_ar_ctrl [get_bd_pins ila_lib/probe49] [get_bd_pins slot_2_ar/dout]
  connect_bd_net -net net_slot_2_axi_araddr [get_bd_pins g_inst/m_slot_1_axi_araddr] [get_bd_pins ila_lib/probe18]
  connect_bd_net -net net_slot_2_axi_arburst [get_bd_pins g_inst/m_slot_1_axi_arburst] [get_bd_pins ila_lib/probe19]
  connect_bd_net -net net_slot_2_axi_arcache [get_bd_pins g_inst/m_slot_1_axi_arcache] [get_bd_pins ila_lib/probe20]
  connect_bd_net -net net_slot_2_axi_arid [get_bd_pins g_inst/m_slot_1_axi_arid] [get_bd_pins ila_lib/probe21]
  connect_bd_net -net net_slot_2_axi_arlen [get_bd_pins g_inst/m_slot_1_axi_arlen] [get_bd_pins ila_lib/probe22]
  connect_bd_net -net net_slot_2_axi_arlock [get_bd_pins g_inst/m_slot_1_axi_arlock] [get_bd_pins ila_lib/probe23]
  connect_bd_net -net net_slot_2_axi_arprot [get_bd_pins g_inst/m_slot_1_axi_arprot] [get_bd_pins ila_lib/probe24]
  connect_bd_net -net net_slot_2_axi_arqos [get_bd_pins g_inst/m_slot_1_axi_arqos] [get_bd_pins ila_lib/probe25]
  connect_bd_net -net net_slot_2_axi_arready [get_bd_pins g_inst/m_slot_1_axi_arready] [get_bd_pins slot_2_ar/In1]
  connect_bd_net -net net_slot_2_axi_arsize [get_bd_pins g_inst/m_slot_1_axi_arsize] [get_bd_pins ila_lib/probe26]
  connect_bd_net -net net_slot_2_axi_arvalid [get_bd_pins g_inst/m_slot_1_axi_arvalid] [get_bd_pins slot_2_ar/In0]
  connect_bd_net -net net_slot_2_axi_aw_cnt [get_bd_pins g_inst/m_slot_1_axi_aw_cnt] [get_bd_pins ila_lib/probe27]
  connect_bd_net -net net_slot_2_axi_aw_ctrl [get_bd_pins ila_lib/probe46] [get_bd_pins slot_2_aw/dout]
  connect_bd_net -net net_slot_2_axi_awaddr [get_bd_pins g_inst/m_slot_1_axi_awaddr] [get_bd_pins ila_lib/probe28]
  connect_bd_net -net net_slot_2_axi_awburst [get_bd_pins g_inst/m_slot_1_axi_awburst] [get_bd_pins ila_lib/probe29]
  connect_bd_net -net net_slot_2_axi_awcache [get_bd_pins g_inst/m_slot_1_axi_awcache] [get_bd_pins ila_lib/probe30]
  connect_bd_net -net net_slot_2_axi_awid [get_bd_pins g_inst/m_slot_1_axi_awid] [get_bd_pins ila_lib/probe31]
  connect_bd_net -net net_slot_2_axi_awlen [get_bd_pins g_inst/m_slot_1_axi_awlen] [get_bd_pins ila_lib/probe32]
  connect_bd_net -net net_slot_2_axi_awlock [get_bd_pins g_inst/m_slot_1_axi_awlock] [get_bd_pins ila_lib/probe33]
  connect_bd_net -net net_slot_2_axi_awprot [get_bd_pins g_inst/m_slot_1_axi_awprot] [get_bd_pins ila_lib/probe34]
  connect_bd_net -net net_slot_2_axi_awqos [get_bd_pins g_inst/m_slot_1_axi_awqos] [get_bd_pins ila_lib/probe35]
  connect_bd_net -net net_slot_2_axi_awready [get_bd_pins g_inst/m_slot_1_axi_awready] [get_bd_pins slot_2_aw/In1]
  connect_bd_net -net net_slot_2_axi_awsize [get_bd_pins g_inst/m_slot_1_axi_awsize] [get_bd_pins ila_lib/probe36]
  connect_bd_net -net net_slot_2_axi_awvalid [get_bd_pins g_inst/m_slot_1_axi_awvalid] [get_bd_pins slot_2_aw/In0]
  connect_bd_net -net net_slot_2_axi_b_cnt [get_bd_pins g_inst/m_slot_1_axi_b_cnt] [get_bd_pins ila_lib/probe37]
  connect_bd_net -net net_slot_2_axi_b_ctrl [get_bd_pins ila_lib/probe48] [get_bd_pins slot_2_b/dout]
  connect_bd_net -net net_slot_2_axi_bid [get_bd_pins g_inst/m_slot_1_axi_bid] [get_bd_pins ila_lib/probe38]
  connect_bd_net -net net_slot_2_axi_bready [get_bd_pins g_inst/m_slot_1_axi_bready] [get_bd_pins slot_2_b/In1]
  connect_bd_net -net net_slot_2_axi_bresp [get_bd_pins g_inst/m_slot_1_axi_bresp] [get_bd_pins ila_lib/probe39]
  connect_bd_net -net net_slot_2_axi_bvalid [get_bd_pins g_inst/m_slot_1_axi_bvalid] [get_bd_pins slot_2_b/In0]
  connect_bd_net -net net_slot_2_axi_r_cnt [get_bd_pins g_inst/m_slot_1_axi_r_cnt] [get_bd_pins ila_lib/probe40]
  connect_bd_net -net net_slot_2_axi_r_ctrl [get_bd_pins ila_lib/probe50] [get_bd_pins slot_2_r/dout]
  connect_bd_net -net net_slot_2_axi_rdata [get_bd_pins g_inst/m_slot_1_axi_rdata] [get_bd_pins ila_lib/probe41]
  connect_bd_net -net net_slot_2_axi_rid [get_bd_pins g_inst/m_slot_1_axi_rid] [get_bd_pins ila_lib/probe42]
  ...
  connect_bd_net -net net_slot_2_axi_rresp [get_bd_pins g_inst/m_slot_1_axi_rresp] [get_bd_pins ila_lib/probe43]
  ...
  connect_bd_net -net net_slot_2_axi_wdata [get_bd_pins g_inst/m_slot_1_axi_wdata] [get_bd_pins ila_lib/probe44]
  ...
  connect_bd_net -net net_slot_2_axi_wstrb [get_bd_pins g_inst/m_slot_1_axi_wstrb] [get_bd_pins ila_lib/probe45]
