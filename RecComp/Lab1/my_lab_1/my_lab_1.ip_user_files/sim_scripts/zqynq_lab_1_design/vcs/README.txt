...
#
# Generated by export_simulation on Wed Sep 20 21:27:41 -0400 2017
#
################################################################################
...
switch to the './zqynq_lab_1_design.sh' script.

./zqynq_lab_1_design.sh -reset_run
...
./zqynq_lab_1_design.sh -noclean_files

For more information on the script, please type './zqynq_lab_1_design.sh -help'.
